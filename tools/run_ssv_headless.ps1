...
if (($TraceStartFrame -ge 0) -xor ($TraceStopFrame -ge 0)) {
    throw 'TraceStartFrame and TraceStopFrame must be supplied together'
}
if (($TraceStartFrame -ge 0) -and ($TraceStopFrame -lt $TraceStartFrame)) {
    throw 'TraceStopFrame must be greater than or equal to TraceStartFrame'
}
...
if ($scenarioManifest) {
    ...
    if (($TraceStartCycle -eq 0) -and ($TraceStopCycle -eq 0) -and
        ($TraceStartFrame -lt 0) -and ($TraceStopFrame -lt 0) -and
